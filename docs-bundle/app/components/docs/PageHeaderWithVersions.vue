...
<template>
  ...
  <div v-if="showDeprecatedBanner"
    class="rounded-lg p-3 mt-8 mb-3 bg-linear-to-r from-orange-50/50 to-transparent dark:from-orange-950/10 dark:to-transparent border-l-4 border-orange-200 dark:border-orange-800/50">
