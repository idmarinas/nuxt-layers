...
function generateLocalePath(locale: string): string
{
  return router.resolve({name: route.name, params:{...route.params, lang: locale}}).path
}
</script>
      ...
      <ul class="flex flex-col gap-2">
        ...
        >
          <NuxtLink
            ...
            :to="generateLocalePath(localeItem.code)"
